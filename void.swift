...
func sayHello(url: String) {
        ...
        let postData = "client_username={yourUsername}&client_password={yourPassword}&client_token=token&processing_type=VOID&original_transaction_id=A000177MEKX".data(using: String.Encoding.utf8);
